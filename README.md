...
使用go-videosite-server开发分布式WebAPI: 用最简单的架构, 实现支持分布式的够用的框架, 服务大量的用户.
...
7. [go-videosite-server Task](https://github.com/xiangrui2019/go-videosite-server_task) 自行实现了分布式定时任务
...
6. 实现了```time```定时任务, 配合[go-videosite-server Task](https://github.com/xiangrui2019/go-videosite-server_task)使用
